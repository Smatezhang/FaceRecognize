package com.itek.facerecognize.face.faceserver;
...
import com.itek.facerecognize.face.model.FaceRegisterInfo;
...
public class FaceServer {
     ...
     * @return 是否注册成功
     */
    public byte[] registerNv21(Context context, byte[] nv21, int width, int height, FaceInfo faceInfo, String name) {
        synchronized (this) {
